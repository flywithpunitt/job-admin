...
import { useDeleteIndustryMutation, useGetIndustryQuery} from 'src/services';
...
export default function IndustryList() {
    ...
    const { data,isLoading} = useGetIndustryQuery({
        limit: limit,
        offset: limit * offset,
    });
    ...
    const toYes = async () => {
        ...
        try {
            await deleteIndustry({ id: update.id }).unwrap();
            handleCloseMenu();
            setOpen(null)
        ...
        <>
            ...
            <Typography variant="h4" component="h4" paragraph>
                ...
                <Button
                    ...
                    to={PATH_DASHBOARD.industry.new}
