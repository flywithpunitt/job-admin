...
export default function Jobdetails() {
    ...
    const { data, isLoading } = useGetjobQuery({
        limit: limit,
        offset: limit * offset,
        status: status == null || "" ? null : status === "all" ? "" : status,
    date_range: dateRange == null || "" ? null : dateRange,
    });
    ...
    const columns: Column[] = [
        ...
        { id: 'job_category_name', label: 'Category', minWidth: 100, },
        { id: 'industry_name', label: 'Industry', minWidth: 100 },
        { id: 'requirements', label: 'Required Skills', minWidth: 100, align: 'right', },
        { id: 'salary_range_min', label: 'Minimum Salary', minWidth: 100, align: 'right', },
        { id: 'salary_range_max', label: 'Maximum Salary', minWidth: 100, align: 'right', },
        { id: 'company_name', label: 'Company Name', minWidth: 100, align: 'right', },
        ...
        { id: 'action', label: 'Action', align: 'right', type: "action" },
    ];
                        ...
                        <Card elevation={0} sx={{ p: 5 }}>
                            <Stack direction='column' spacing={2}>
                                ...
                                <RHFSelect name="status" label="Change Status" placeholder="Change Status">
                                    ...
                                    <MenuItem key={1} value={"approved"} selected>Approved</MenuItem>
                                    <MenuItem key={2} value={"pending"} >Pending</MenuItem>
                                    <MenuItem key={3} value={"flagged"} >Flagged</MenuItem>

                                    <MenuItem key={4}value={"rejected"} >Rejected</MenuItem>
                                </RHFSelect>
                                {
                                    values.status === 'rejected' && (
                                        <RHFTextField  name="remarks" label="Reason" placeholder="Reason" />
                                    )
                                }
